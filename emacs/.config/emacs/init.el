...
(set-face-attribute 'fixed-pitch nil :font "Inconsolata" :height 155 :width 'medium)
...
(defun manga()
  ...
  (async-shell-command "nomacs *")))

(defun anime()
  (interactive)
  (save-window-excursion
  (async-shell-command "mpv *")))
